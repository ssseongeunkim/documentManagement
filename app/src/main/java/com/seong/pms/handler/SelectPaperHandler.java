...
public class SelectPaperHandler {
  ...
  public SelectPaperHandler(MemberHandler memberHandler, PaperHandler paperHandler) {
  ...
  void allPaper() {
    ...
    {
      Prompt.println("");
      Prompt.println("[문서관리 시스템 / 서류목록 / 모든 서류 리스트]");

      paperHandler.printAll();
      String value = Prompt.inputString("확인할 문서의 작성자 사번 또는 이름을 입력하세요.\n0. 뒤로가기\n99. 종료\n> ");
      ...
      paperHandler.existPaper(m.getName());
